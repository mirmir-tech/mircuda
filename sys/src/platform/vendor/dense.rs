...
unsafe extern "C" {
    fn mircuda_cublaslt_dense_create(
        m: i32,
        n: i32,
        k: i32,
        stream: *mut c_void,
    ...
    fn mircuda_cublaslt_dense_workspace_bytes(plan: *const c_void) -> usize;
    fn mircuda_cublaslt_dense_execute(
        plan: *mut c_void,
        stream: *mut c_void,
        a: *const c_void,
        b: *const c_void,
    ...
    fn mircuda_cublaslt_dense_destroy(plan: *mut c_void);
}
...
unsafe impl Send for CublasLtBf16Plan {}

impl Context {
    pub fn create_cublaslt_bf16_plan(
        &self,
        stream: &Stream,
        spec: CublasLtBf16Spec,
...
impl CublasLtBf16Plan {
    ...
    pub fn workspace_bytes(&self) -> usize {
        ...
        unsafe { mircuda_cublaslt_dense_workspace_bytes(self.raw.as_ptr()) }
    }
    ...
    pub fn execute(
        ...
        let status = unsafe {
            mircuda_cublaslt_dense_execute(
                self.raw.as_ptr(),
                stream.inner.cu_stream().cast(),
